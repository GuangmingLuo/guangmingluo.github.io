...
2026年5月前后，中国AI开源生态密集发布重磅项目：①灵玑OS（北京经开区指导的AI智能体共性基础设施）、②鲸智百应（浩鲸科技企业AI操作系统四大组件开源）、③OpenClaw（本地优先AI Agent框架，支持微信/飞书远程指令）、④摩尔线程MUSA（国产GPU适配SGLang）、⑤SoulXFlashTalk（14B参数实时数字人模型，0.87秒延时、32fps帧率）。国产开源大模型下载量全球居首，千问衍生模型超20万，下载量破10亿。
...
OpenAI与Anthropic的AI编程工具补贴战持续升级：Anthropic宣布6月15日起提升50% Claude Code编程额度；OpenAI火速反击，30天内迁移至Codex可获2个月免费试用（价值400美元）。与此同时，微软内部要求数千名开发者在6月30日前切换至GitHub Copilot CLI。Claude Code驱动Anthropic估值冲至1.2万亿美元，超越OpenAI（约8520亿美元）。分析指出，垂直场景（编程）的商业价值已证明可超越通用大模型，开发者短期享受补贴红利。
