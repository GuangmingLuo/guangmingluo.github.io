---
title: "2026年5月12日 每日科技早报"
date: 2026-05-12T08:00:00+08:00
categories: ["每日早报"]
tags: ["科技新闻", "人工智能", "云计算"]
description: "2026年5月12日 科技新闻摘要，涵盖人工智能、云计算、开源社区等领域的最新动态。"
---

## 📰 头条新闻

**百度文心5.1发布，登顶国内第一、全球第四**

5月11日，百度发布文心大模型5.1，在LM Arena搜索榜中斩获国内第一、全球第四的好成绩，也是目前唯一上榜的国产大模型。更重要的是，文心5.1采用"多维弹性预训练"技术，预训练成本仅为业界同规模模型的6%，总参数压缩至1/3，标志着国产大模型在降本增效方面取得重大突破。
...
5月5日，CNCF毕业项目Kyverno发布1.18版本，带来重要安全改进：

- **HTTP执行安全加固**：默认屏蔽loopback和metadata服务地址，防止SSRF攻击
- **CLI能力扩展**：`kyverno apply`和`kyverno test`命令新增对Cleanup策略、HTTP策略、Envoy授权策略的支持
- **支持模式调整**：采用"main + 1"支持模式，当前版本和上一个版本各获约3个月安全补丁支持
...
曾因邀请码炒至数万元而备受关注的AI智能体平台Manus宣布全面开放注册，所有用户无需邀请码即可免费体验。注册用户将一次性获得1000积分奖励，并可每日免费获得300积分。

📖 来源：[CSDN - AI Weekly](https://blog.csdn.net/weixin_40774379/article/details/148038119)

**ATH跨平台智能体交互协议正式开源**

5月9日，跨平台智能体交互协议ATH正式开源，核心解决智能体跨平台对接的身份互验、权限管控、行为审计三大痛点，免费向全行业开放，打破大厂技术垄断。高盛预测，ATH协议推动下，2030年全球企业级智能体规模将达2026年的24倍。
...
| 项目 | Stars | 定位 |
|------|-------|------|
| OpenClaw | 203k+ | 个人AI Agent操作系统 |
| Dify | 156k+ | 企业级AI工作流构建器 |
| everything-claude-code | 近期+22.8k | Claude Code技能框架 |
| Browser Use | 67k+ | AI驱动的浏览器自动化 |

本周新晋热门项目：

- **goose**：Block开源的AI Agent，迁移至Linux基金会Agentic AI Foundation，获得44.5k Stars
- **PageIndex**：推理式RAG新范式，29.5k Stars，无需向量库
- **DFlash**：扩散模型推理加速，支持20+主流模型，已被vLLM原生集成

📖 来源：[CSDN - GitHub热点开源项目Top10](https://blog.csdn.net/xyz030556/article/details/160889735)
